...
function GenerateFlags(atlas, tilewidth_1, tileheight_1, tilewidth_2, tileheight_2)
    local sheetWidth = atlas:getWidth() / tilewidth_1
    local sheetHeight = atlas:getHeight() - 16 / tileheight_1
    ...
    for x = 0, 5 do
        spritesheet[sheetCounter] =
            love.graphics.newQuad(x * tilewidth_1, 0, tilewidth_1,
            tileheight_1, atlas:getDimensions())
        sheetCounter = sheetCounter + 1
    end
    ...
    for y = 0, 3 do
        for x = 6, 8 do
            spritesheet[sheetCounter] =
                love.graphics.newQuad(x * 16, y * 16, 16,
