...
function PlayerJumpState:update(dt)
    ...
    local tileLeft = self.player.map:pointToTile(self.player.x + 9, self.player.y)
    local tileRight = self.player.map:pointToTile(self.player.x + self.player.width - 9, self.player.y)
