...
function love.load()
    ...
    gSounds['paddle-hit']:setVolume(0.01)
    gSounds['brick-hit-1']:setVolume(0.01)
    gSounds['brick-hit-2']:setVolume(0.01)
    gSounds['wall-hit']:setVolume(0.01)
    gSounds['hurt']:setVolume(0.01)
    gSounds['score']:setVolume(0.01)
    gSounds['confirm']:setVolume(0.01)
