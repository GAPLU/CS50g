...
function Entity:init(def)
    ...
    -- flag for drawing stencils above pots
    self.stencil = false

    -- track the raised pot to change the selection of the states
    self.raised_pot = nil

    -- check whether the entity is a player, prevents collision detection 
    -- of the flying pot with the player
    self.player = false
